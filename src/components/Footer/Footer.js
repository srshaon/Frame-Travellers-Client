        ...
        <div className="footer-section-container">
            <div className="container  w-100 py-4 px-2">
                <div className="row p-2 footer-container-row">
                    <div style={{ border: '3px solid #fcffb0', backgroundColor: '#fffcefd3', borderRadius: '10px', boxShadow: '1px 3px 2px 3px' }} className="col pt-2 mx-2 ">
                        <div>
                            <h5 style={{ color: '#1a1b29', fontWeight: '600' }}>Join The Community <i className="fas fa-users"></i></h5>
                        </div>
                        <div className="p-2">
                    ...
                    <div style={{ border: '3px solid #fcffb0', backgroundColor: '#fffcefd3', borderRadius: '10px', boxShadow: '1px 3px 2px 3px' }} className="col-5 pt-2 mx-2 footer-mid-column">
                        <div>
                            <h6 style={{ fontWeight: '700' }}>Get Updates On Events, Offers And More</h6>
                        </div>
                        <div>
                            <input id="input-field" className="w-75 email-box form-label text-center" type="text" name="email" placeholder="Enter Your Email" />
                        </div>
                        <div >
                            <button className="mb-1 subscribe-btn"><i class="fas fa-bell"></i> Subscribe</button>
                        </div>
                    </div>
                    <div style={{ border: '3px solid #fcffb0', backgroundColor: '#fffcefd3', borderRadius: '10px', boxShadow: '1px 3px 2px 3px' }} className="col pt-2 mx-2">
                        <div>
                            <h5 style={{ fontWeight: '700' }}>Our Location <i class="fas fa-clinic-medical"></i></h5>
                        </div>
                        <div>
            ...
            <div className="d-flex ">
                ...
                <a className="fixed-bottom d-flex flex-row-reverse pe-2" style={{ color: "red" }} href="#"><h1 style={{ fontSize: "40px" }}><strong ><i class="far fa-arrow-alt-circle-up"></i></strong></h1></a>
